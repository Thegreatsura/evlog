...
export default defineWorkflowTool({
  description: 'Run Evi\'s bounded repository simplification audit. Fan out exact code, test, architecture, and communication scopes to independent hidden reviewers, then have a fifth reviewer try to disprove every finding. Use only after reading the simplification coverage ledger and checking out a clean current main.',
